...
class NumberOperator(var initial: Number = 0) {
	...
	@JvmOverloads
	fun plus(o: Number, lineNumber: Int = -1): NumberOperator {
	...
	@JvmOverloads
	fun minus(o: Number, lineNumber: Int = -1): NumberOperator {
		val hisLevel = getLevel(o, lineNumber)
		if (hisLevel <= level) {
			initial = minusValue(o, initial, lineNumber)
		} else {
			initial = minusValue(initial, o, lineNumber, true)
			level = getLevel(initial)
		}
		return this
	}
	...
	@JvmOverloads
	fun times(o: Number, lineNumber: Int = -1): NumberOperator {
		val hisLevel = getLevel(o, lineNumber)
		if (hisLevel <= level) {
			initial = timesValue(o, initial, lineNumber)
		} else {
			initial = timesValue(initial, o, lineNumber)
			level = getLevel(initial)
		}
		return this
	}
	...
	@JvmOverloads
	fun div(o: Number, lineNumber: Int = -1): NumberOperator {
		val hisLevel = getLevel(o, lineNumber)
		if (hisLevel <= level) {
			initial = divValue(o, initial, lineNumber)
		} else {
			initial = divValue(initial, o, lineNumber)
			level = getLevel(initial)
		}
		return this
	}
